...
Build a web page that displays the content and matches the design below as close as possible. The page should be responsive, and should support common resolutions ranging from mobile to desktop.
